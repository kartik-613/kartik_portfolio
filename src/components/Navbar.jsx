  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`hidden md:flex mx-auto items-center justify-between px-6 py-4 transition-all duration-300 max-w-6xl border ${
          theme === 'dark' 
        ...
        <nav className="flex items-center gap-8 text-sm relative">
          {navItems.map((item, idx) => (
            <motion.a
              key={idx}
              href={item.link}
              className={`transition relative px-3 py-1 rounded-full z-10 ${
      ...
      <motion.div
        ...
        className={`md:hidden mx-auto transition-all duration-300 max-w-6xl border ${
          theme === 'dark' 
            ...
            <div className="flex flex-col gap-4">
              {navItems.map((item, idx) => (
                <a
                  ...
                  className="py-2 text-sm hover:text-gray-300 transition"
                >
                  {item.name}
                </a>
              ))}
